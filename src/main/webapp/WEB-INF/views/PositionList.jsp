	...
	<c:import url="/Menu"/>
			<div class="panel panel-success">
				<h3 class="panel-title">
					<div align="left"><b>Position List</b></div>
				</h3>
			</div>
						...
						<tbody>
							<c:forEach items="${ItemList.pageList}" var="item">
								<tr>
									...
									<th><a href="<%=request.getContextPath()%>/Position/edit?id=<c:out value='${item.id}'/>">Edit</a></th>
									<th><a href="<%=request.getContextPath()%>/Position/delete?id=<c:out value='${item.id}'/>">Delete</a></th>
								</tr>
							</c:forEach>
						</tbody>
					</table>
