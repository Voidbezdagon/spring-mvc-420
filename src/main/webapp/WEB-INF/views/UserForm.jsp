						...
						<form:form id="reportRegisterForm" cssClass="form-horizontal" enctype="multipart/form-data" modelAttribute="item" method="post" action="save">
							<div class="form-group">
								...
								<div class="col-xs-6">
									...
									<form:input cssClass="form-control" path="firstname" value="${itemObject.firstname}"/>
							...
							<div class="form-group">
								...
								<div class="col-xs-6">
									<form:input cssClass="form-control" path="lastname" value="${itemObject.lastname}"/>
									<form:errors path="lastname" cssClass="error"/>
								</div>
							</div>
								<div class="form-group">
									<div class="control-label col-xs-3"> <form:label path="username" >User Name</form:label> </div>
									<div class="col-xs-6">
										<form:input cssClass="form-control" path="username" value="${itemObject.username}"/>
							...
							<div class="form-group">
								...
								<div class="col-xs-6">
									<form:input cssClass="form-control" path="password" value="${itemObject.password}"/>
							...
							<div class="form-group">
								<div class="control-label col-xs-3"> <label name="position.id">Position</label> </div>
								<div class="col-xs-6">
								<select name="position.id" id="position.id">
							...
							<div class="form-group">
									<div class="control-label col-xs-3"><label name="file">Avatar</label> <img src="data:image/jpeg;base64, ${userAvatar}" height="50px" width="50px" /></div>
									<div class="col-xs-4">
							...
							<div class="form-group">
								<div class="row">
									...
									<div class="col-xs-4">
										<input type="submit" id="<%=request.getContextPath()%>/User/save" class="btn btn-primary" value="Submit"/>
									</div>
									<div class="col-xs-4">
									</div>
								</div>
