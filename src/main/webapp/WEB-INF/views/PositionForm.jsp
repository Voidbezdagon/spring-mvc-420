				...
				<div class="panel panel-success">
					...
					<div class="panel-body">
						<form:form id="reportRegisterForm" cssClass="form-horizontal" enctype="multipart/form-data" modelAttribute="item" method="post" action="save">
							...
							<div class="form-group">
								<div class="control-label col-xs-3"> <form:label path="parentId" >Superior Position</form:label> </div>
								<div class="col-xs-6">
							...
							<div class="form-group">
								<div class="row">
									...
									<div class="col-xs-4">
										<input type="submit" id="<%=request.getContextPath()%>/Position/save" class="btn btn-primary" value="Submit"/>
									</div>
									<div class="col-xs-4">
									</div>
								</div>
