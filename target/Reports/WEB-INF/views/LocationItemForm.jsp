					...
					<div class="panel-body">
						<form:form id="reportRegisterForm" cssClass="form-horizontal" enctype="multipart/form-data" modelAttribute="item" method="post" action="save">
							...
							<div class="form-group">
								...
								<div class="col-xs-6">
									<form:input cssClass="form-control" path="floor" value="${itemObject.floor}"/>
									<form:errors path="floor" cssClass="error"/>
								</div>
							</div>
								<div class="form-group">
									<div class="control-label col-xs-3"> <form:label path="number" >Number</form:label> </div>
									<div class="col-xs-6">
										<form:input cssClass="form-control" path="number"/>
										<form:errors path="number" cssClass="error" value="${itemObject.number}"/>
									</div>
								</div> 
							...
							<div class="form-group">
								<div class="row">
									...
									<div class="col-xs-4">
										...
										<input type="submit" id="<%=request.getContextPath()%>/LocationItem/save" class="btn btn-primary" value="Submit"/>
									</div>
									<div class="col-xs-4">
									</div>
								</div>
