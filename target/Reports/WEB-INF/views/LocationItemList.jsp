						...
						<tbody>
							<c:forEach items="${ItemList.pageList}" var="item">
								<tr>
									...
									<th><a href="<%=request.getContextPath()%>/LocationItem/edit?id=<c:out value='${item.id}'/>">Edit</a></th>
									<th><a href="<%=request.getContextPath()%>/LocationItem/delete?id=<c:out value='${item.id}'/>">Delete</a></th>
								</tr>
							</c:forEach>
