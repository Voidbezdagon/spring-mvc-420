	...
	<c:import url="/Menu"/>
			...
			<div class="panel-body">
				...
				<c:if test="${not empty ItemList}">
					...
					<form action="<%=request.getContextPath()%>/User/getAll">
						<div class="row">
						...
						<tbody>
							<c:forEach items="${ItemList.pageList}" var="item">
								<tr>
									...
									<th><img src="data:image/jpeg;base64, ${item.avatar}" height="50px" width="50px" /></th>
									...
									<th><a href="<%=request.getContextPath()%>/User/edit?id=<c:out value='${item.id}'/>">Edit</a></th>
									<th><a href="<%=request.getContextPath()%>/User/delete?id=<c:out value='${item.id}'/>">Delete</a></th>
								</tr>
							</c:forEach>
						</tbody>
					</table>
